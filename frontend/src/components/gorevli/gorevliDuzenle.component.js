...
export default class gorevliDuzenle extends Component {
    constructor(props) {
        super(props);
    ...
    addRequest() {
        ...
        axios.put('http://localhost:8080/api/gorevli/' + cookie.get("gorevliIdForEdit"), body)
            .then(response => {
    ...
    refreshList() {
        let cookie = new Cookies();
        axios.get('http://localhost:8080/api/gorevli/' + cookie.get("gorevliIdForEdit"))
            .then(response => {
        ...
        return (
            <div className="auth-inner">
                ...
                <div className="form-group">
                    ...
                    <input type="text" className="form-control" placeholder="TCNO Giriniz" onChange={this.changetckn} value={tckn} />
                </div>
